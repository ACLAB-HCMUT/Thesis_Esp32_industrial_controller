...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "partitions_lvgl.csv"
#define CONFIG_PARTITION_TABLE_FILENAME "partitions_lvgl.csv"
...
#define CONFIG_ESP_IPC_TASK_STACK_SIZE 4096
